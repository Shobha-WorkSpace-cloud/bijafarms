 ...
 */
export const createExpenseExportConfig = (): Omit<ExportConfig<ExpenseRecord>, 'data'> => ({
  filename: createExportFilename('bija-expenses'),
  columns: [
    { key: 'date', header: 'Date' },
    { key: 'type', header: 'Type' },
    { key: 'description', header: 'Description' },
    { key: 'amount', header: 'Amount', formatter: (value) => formatters.currency(value) },
...
export const createTaskExportConfig = (): Omit<ExportConfig<Task>, 'data'> => ({
  ...
  columns: [
    ...
    { 
      key: 'category', 
      header: 'Category', 
      formatter: (value) => formatters.replaceUnderscore(formatters.capitalize(value))
    },
    { 
      key: 'taskType', 
      header: 'Task Type', 
 ...
 */
export const createAnimalExportConfig = (): Omit<ExportConfig<AnimalRecord>, 'data'> => ({
  ...
  columns: [
    ...
    { key: 'purchaseDate', header: 'Purchase Date', formatter: formatters.date },
